...
class Rf2_Folders:
  def __init__(self, base_directory, release_type, rel_config='Relationship', language_code='en', language_name='Language'):
    ...
    supported_language_names = ['Language','USEnglish', 'SpanishExtension']
    ...
    # TODO param
    self.release_type_root_folder_name = 'SpanishExtension' + self.release_type_root_folder_name
    ...
    print('self.release_type_root_folder_name: ' + self.release_type_root_folder_name)
    ...
    #                                                  sct2_Concept_Full_INT_20221130.txt
