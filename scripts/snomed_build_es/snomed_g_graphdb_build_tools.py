...
class StatusDb():
  def __init__(self, filename="build_status.db"):
    ...
    try:    c.execute('''insert into seq values ('BUILD', 0)''')
      ...
      print('sequence did not exist, primed')
...
def db_build(arglist):
  ...
  print('opts.rf2: '+opts.rf2)
  print('opts.release_type: ' + opts.release_type)
  print('opts.relationship_file: ' + opts.relationship_file)
  print('opts.language_code: ' + opts.language_code)
